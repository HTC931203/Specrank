...
arrow5 = plt.arrow(x[0],y1[0],x[119]-x[0],y1[119]-y1[0],width=0.001,length_includes_head=True,head_width=0.07, head_length=0.05,color='lightcoral',label='C1_CoeVec')
arrow6 = plt.arrow(x[0],y2[0],x[199]-x[0],y2[199]-y2[0],width=0.001,length_includes_head=True,head_width=0.07, head_length=0.05,color='dodgerblue',label='C2_CoeVec')
...
plt.legend([arrow1,arrow2,arrow5,arrow6], ['Class 1 Worker Specialty Vector','Class 2 Worker Specialty Vector','Class 1 Feature Vector','Class 2 Feature Vector','Class 3 Feature Vector'],prop={'size': 12},loc='upper left')
#plt.gcf().savefig("worker_project_on_syn_dataet.png",bbox_inches='tight', dpi=300)
plt.show()
