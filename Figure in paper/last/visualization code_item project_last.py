...
true_c = np.load("dim2_2 lastfm update_expa.npy")
...
C1_item = plt.scatter(C1[:,0],C1[:,1],s=30,c='red',marker='p',alpha=0.3,label='C1')
...
'''
arrow1 = plt.arrow(x[53],y1[53],x[47]-x[53],y1[47]-y1[53],width=0.001,length_includes_head=True,head_width=0.07, head_length=0.05,color='lightcoral',label='C1_CoeVec')
#arrow2 = plt.arrow(x[99],y2[99],x[0]-x[99],y2[0]-y2[99],width=0.001,length_includes_head=True,head_width=0.07, head_length=0.05,color='dodgerblue',label='C2_CoeVec')
...
plt.legend([C1_item,C2_item,arrow1], ['Class 1','Class 2','Class 1 Feature Vector'],prop={'size': 12},loc='lower left')
#plt.gcf().savefig("last_es_C2_pro.png",bbox_inches='tight', dpi=300)
plt.show()     
